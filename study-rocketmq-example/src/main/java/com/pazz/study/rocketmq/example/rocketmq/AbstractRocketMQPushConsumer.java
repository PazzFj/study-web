package com.pazz.study.rocketmq.example.rocketmq;

import com.pazz.study.rocketmq.example.utils.JsonUtils;
import lombok.Data;
...
public abstract class AbstractRocketMQPushConsumer<T> {
     ...
     * 继承这个方法处理消息
     */
    protected abstract boolean process(T object, MessageExt messageExt, ConsumeConcurrentlyContext consumeConcurrentlyContext);

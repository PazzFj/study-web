package com.pazz.springboot.example.redis.storage;

import com.pazz.springboot.example.cache.CacheManager;
import com.pazz.springboot.example.cache.IRefreshableCache;
...
import com.pazz.springboot.example.cache.provider.IBatchCacheProvider;
